...
namespace XMusic.Audio
{
    ...
    {
        public const string ActionStart = "mx.xperience.START";
        public const string ActionPlay = "mx.xperience.PLAY";
        public const string ActionPause = "mx.xperience.PAUSE";
        public const string ActionNext = "mx.xperience.NEXT";
        public const string ActionPrev = "mx.xperience.PREV";
        public const string ActionToggle = "mx.xperience.TOGGLE";
        public const string ActionStop = "mx.xperience.STOP";
        public const string ActionTryKill = "mx.xperience.TRY_KILL";
